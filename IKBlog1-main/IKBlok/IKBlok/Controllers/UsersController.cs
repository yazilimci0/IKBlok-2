...
namespace IKBlok.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(IKBlokContex context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserAdi,Password")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserAdi,Password")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
