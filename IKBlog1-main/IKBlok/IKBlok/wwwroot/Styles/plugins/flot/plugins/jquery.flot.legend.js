...
(function($) {
    ...
    function getEntryIconHtml(shape) {
        ...
        switch (name) {
            case 'circle':
                html = '<use xlink:href="AdminLTE/#circle" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'diamond':
                html = '<use xlink:href="AdminLTE/#diamond" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'cross':
                html = '<use xlink:href="AdminLTE/#cross" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'rectangle':
                html = '<use xlink:href="AdminLTE/#rectangle" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'plus':
                html = '<use xlink:href="AdminLTE/#plus" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
                ...
                break;
            case 'bar':
                html = '<use xlink:href="AdminLTE/#bars" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    // 'stroke="' + stroke + '" ' +
                ...
                break;
            case 'area':
                html = '<use xlink:href="AdminLTE/#area" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    'fill="' + fill + '" ' +
                    // 'stroke="' + stroke + '" ' +
                ...
                break;
            case 'line':
                html = '<use xlink:href="AdminLTE/#line" class="legendIcon" ' +
                    'x="' + x + '" ' +
                    'y="' + y + '" ' +
                    // 'fill="' + fill + '" ' +
                    'stroke="' + stroke + '" ' +
